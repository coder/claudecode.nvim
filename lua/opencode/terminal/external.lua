--- External terminal provider for OpenCode.
---Launches OpenCode in an external terminal application using a user-specified command.
---@module 'opencode.terminal.external'
