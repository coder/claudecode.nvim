---Snacks.nvim terminal provider for OpenCode.
...
---@param config OpenCodeTerminalConfig Terminal configuration
...
function M.setup()
  ...
  vim.api.nvim_create_autocmd("VimLeave", {
    group = vim.api.nvim_create_augroup("OpenCodeSnacksCleanup", { clear = true }),
    callback = function()
