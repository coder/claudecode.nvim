---@brief [[
--- Manages configuration for the OpenCode Neovim integration.
...
M.defaults = {
  ...
  env = {}, -- Custom environment variables for OpenCode terminal
  log_level = "info",
  track_selection = true,
  -- When true, focus OpenCode terminal after a successful send while connected
  focus_after_send = false,
  visual_demotion_delay_ms = 50, -- Milliseconds to wait before demoting a visual selection
  connection_wait_delay = 600, -- Milliseconds to wait after connection before sending queued @ mentions
  connection_timeout = 10000, -- Maximum time to wait for OpenCode to connect (milliseconds)
...
---@return OpenCodeConfig config The final, validated configuration table.
